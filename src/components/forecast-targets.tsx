    ...
    <div className="rounded-xl border bg-card shadow-sm shadow-black/[0.04] overflow-hidden">
      ...
      >
        ...
        {forecast.riskCategory && forecast.riskCategory.riskScore > 0.05 && (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-medium bg-amber-50 text-amber-700 ring-1 ring-inset ring-amber-600/20 flex-shrink-0">
